...
## 9. AI-use disclosure  
We used UvA AI Chat for (1) ... and (2) ... and ... .
We reviewed and edited all suggestions, ran the script end-to-end, and verified outputs on sample inputs. Final work is my responsibility.
